...
// Sprites holds all 27. Generated from the design tables; the widths are
// enforced by TestEverySpriteRowIsExactlyTheCardWidth.
var Sprites = map[string]Sprite{
	"spark":        {"         ", "   ▗▄▄▖  ", "  ▐    ▌ ", "   ▝▀▀▘  ", "    ▘▝   ", [2]rune{'.', '.'}, [2]int{4, 6}},
	"pattern":      {"  |   |  ", " ▗█▀█▀█▖ ", "▐█     █▌", " ▝█▄█▄█▘ ", "  ▘   ▝  ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"probe":        {"  \\ o    ", " ▗█████▖ ", "▐█     █▌", " ▝█████▘ ", "  ▘   ▝  ", [2]rune{'O', 'O'}, [2]int{3, 5}},
	"ember":        {"  /   /  ", "▗██████▖ ", "█     ██▌", " ▝████▘  ", " ▘ ▘  ▝  ", [2]rune{'>', '>'}, [2]int{2, 4}},
	...
	"cartographer": {"  ╔═══╗  ", " ▗█████▖ ", "▐█     █▌", " ▝█████▘ ", "  ▘   ▝  ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"oracle":       {"  o - o  ", " ▗█████▖ ", "▐█     █▌", " ▝█████▘ ", "  ▘   ▝  ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"bolt":         {"  / / /  ", "▗██████▖ ", "▐█     █▌", " ▝████▘  ", "   ▘▘    ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"sniper":       {"  =[+]=  ", "▗██████▖ ", "▐█     █▌", " ▝████▘  ", "   ▘▘    ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"ox":           {" \\_   _/ ", "▗███████▖", "▐█     █▌", "▝███████▘", " ▘ ▘ ▝ ▝ ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"mole":         {"  \\\\ //  ", "▗███████▖", "▐█     █▌", "▝███████▘", " ▘ ▘ ▝ ▝ ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"gremlin":      {" ^ \\ / ^ ", " ▗█▀█▀█▖ ", "▐█     █▌", " ▝█▀█▀█▘ ", " ▘  ▝  ▝ ", [2]rune{'>', '<'}, [2]int{3, 5}},
	"kraken":       {" ~ ~ ~ ~ ", " ▗█▀█▀█▖ ", "▐█     █▌", " ▝█▀█▀█▘ ", " ▘  ▝  ▝ ", [2]rune{'>', '<'}, [2]int{3, 5}},
